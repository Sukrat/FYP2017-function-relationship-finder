...
////            data.setRawColumns(new ArrayList<>());
//            for (int j = 0; j < numColumn; j++) {
////                data.getRawColumns().add(j + Faker.nextDouble() + i / 5);
//            }
//            list.add(data);
//        }
//        return list;
...
////            data.setRawColumns(new ArrayList<>());
////            data.getRawColumns().add(Faker.nextDouble());
//            for (int j = 0; j < gridIndex.size(); j++) {
////                data.getRawColumns().add(gridIndex.get(j) + Faker.nextDouble());
//            }
//            list.add(data);
//        }
